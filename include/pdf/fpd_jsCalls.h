...
#ifndef FPD_JSCALLS_H
#define FPD_JSCALLS_H
...
// Define macros to generate function selectors in the file fpd_jsImpl.h
...
// Define macros to generate function PROTO in the file fpd_jsImpl.h
#define BEGINENUM
